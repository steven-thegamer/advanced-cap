package com.steven.cap.advanced.index;
...
public class UiIndexContentProviderFactory implements IndexContentProviderFactory {
        ...
        private static class UiIndexContentProvider implements IndexContentProvider {
                ...
                public void writeContent(PrintWriter writer, String contextPath) {
                        ...
                        writer.printf(ENDPOINT, contextPath + "/projects/webapp/index.html?sap-ui-xx-viewCache=false", "Read Projects");
                        writer.printf(ENDPOINT, contextPath + "/projectsan/webapp/index.html?sap-ui-xx-viewCache=false", "Analyze Projects");
